...
<body class="bg-light" id="hometop" style="background-color:  #FFFFFF;">

  <!-- Navigation -->
  <nav id="navbar-top"  class="navbar navbar-expand-lg navbar-light fixed-top text-white shadow shadow-sm  " 
  style="background: rgb(63,2,2,0.9);
color:white;">
    <div class="container">
    <img class=" text-white float-right font-weight-bold" src="<?=base_url()?>assets/img/logohimasi.png" class="float-left" witdh="40px" height="40px" alt="">  
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
            <li class="nav-item">
            <a  class="scroll nav-link text-white " href="<?=base_url()?>#eventstab"><strong> Event &nbsp;</strong> </a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
            <a  class="scroll nav-link text-white " href="<?=base_url()?>#kontak"> <strong> Contact &nbsp;</strong></a>
            </li>
