...
<header class="border-0" id="hometop" >
      ...
      <div class="mt-4 text-center carousel " id="slide-2" >
        <div class="alert  bg-transparent alert-dismissible fade show"  role="alert" >
          ...
          background: radial-gradient(circle, rgba(255,76,56,0.3) 25%, rgba(244,52,81,0.2) 75%);">
                          <h2 class="text-center animate__animated animate__bounce animate__infinite	infinite" ><span class=" mt-3 fa fa-2x fa-calendar text-danger"></h1>
  ...
  <div class="container ">
    ...
    <div class="mt-5 mb-5 " data-aos="zoom-in">
      ...
      <hr>
    <!-- end event terbaru -->
    <div class="mt-5 mb-5" id="events" data-aos="zoom-in">
      <h1 class="my-4 text-center "><span class="fa fa-calendar text-danger"></h1>
    ...
    <!-- /.end daftar event -->
     ...
     <!-- end event terbaru -->
    <div class="mt-5 mb-5" id="merchandise" data-aos="zoom-in">
    ...
    <!-- /.end daftar event -->
      ...
      <hr>
                    <div class="row mt-5" id="QnA" data-aos="zoom-in">
                        ...
                        <div class="col col-lg-12 card-body bg-white " data-aos="zoom-in">
              ...
              <div class="col col-lg-12 text-center" id="kontak" data-aos="zoom-in">
                  ...
                  <h3 class=" text-center text-dark"></span> Contact Us<br>
                    <small class="text-danger">____</small></h3>
                                          <!-- <hr class="col-sm-2 col-auto border border-danger mb-4" > -->

                                      </div>
                                  </div>
                <div class="col-lg-6 mt-2 mb-4 " data-aos="zoom-in">
