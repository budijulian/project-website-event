          ...
          <div class="float-left">
              <p>
                  <ul class="list-unstyled">
                   <span class="fa fa-arrow-right"> </span> <li><span class="fa fa-envelope"> </span> himasiunas@gmail.com </li><br>
...
<script>
  ...
  <script type="text/javascript">
      ...
      $(document).ready(function(){
              ...
              if((email != "") && (nama != "")  && (instansi != "") && (jurusan != "") && (nim != "")){
                      //kondisi email peserta pernah digunakan atau tidak
                      $.ajax({
                          url	     : '<?=base_url()?>detail?q=<?=$_GET['q'];?>&kehadiran=true&data=true',
                          type  : "ajax",
                          method : "POST",
                          dataType : "json",
                          data     : {email : email, nama : nama, jurusan : jurusan, instansi : instansi, nim : nim, jalur : jalur},
                          success  : function(hasil){
                      ...
                      <?php if(get_cookie('absen') == 1){ 
                                  echo "Swal.fire({
                                    icon: 'error',
                                    title: 'Oops...',
                                    text: 'Anda tidak boleh mengisi absen dua kali!!',
                                    }) ";
