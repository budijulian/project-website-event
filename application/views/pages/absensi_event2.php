  ...
  <?php foreach($event as $e)?>
	...
	<script type="text/javascript">
      $(document).ready(function(){
              ...
              if((email != "") && (nama != "")  && (instansi != "") && (keterangan != "")){
                      //kondisi email peserta pernah digunakan atau tidak
                      var kd_event = '<?= $_GET['q']; ?>';
                      $.ajax({
                          url	     : '<?=base_url()?>detail?q='+kd_event+'&kehadiran=true&data=true',
                          type  : "ajax",
                          method : "POST",
                          dataType : "json",
                          data     : {email : email, nama : nama, ket_kehadiran : keterangan, instansi : instansi},
                          ...
                          //  clear data form 
                                        ...
                                        $('#keterangan').val("");
                          // redirect halaman
                                 var status = alert("Anda Berhasil Absen, Terimakasih!");
							                window.location.href ="<?=base_url()?>user/delete_session";
                  }
                  else{
                      Swal.fire({
                          icon: 'error',
